...
module.exports = GojoMdNx = async (GojoMdNx, m, chatUpdate, store) => {
	...
	//group target \\
const reply = (teks) => {
            GojoMdNx.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": ` Gojo-Satoru`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./☬༒𝙥𝙧𝙖𝙢𝙚𝙨𝙝༆𝙡𝙞𝙤𝙣 ⃕𝙗𝙤𝙩༒☬/Bot.jpg`),"sourceUrl": "https://i.ibb.co/CMCNByx/Picsart-22-07-03-15-45-00-698.jpg"}}}, { quoted: m})
        }
...
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            locationMessage: {
                            jpegThumbnail: fs.readFileSync('./☬༒𝙥𝙧𝙖𝙢𝙚𝙨𝙝༆𝙡𝙞𝙤𝙣 ⃕𝙗𝙤𝙩༒☬Media/Bot.jpg')},
                            hydratedFooterText: `┌─❖
💚⃨「 Hi 👋 」
💚⃨   ❖ 「 ${pushname} 」
💚⃨  💛⃢💛💛💛⃟💛💛⃞💛⃥💛⃝💛
💚⃨✑ ☬༒𝙥𝙧𝙖𝙢𝙚𝙨𝙝༆𝙡𝙞𝙤𝙣⃕ 𝙗𝙤𝙩༒☬
💚⃨༺═─⃝─⃟─⃟─⃟─⃟─⃟─⃟─⃟─⃟─⃟─⃟─⃟─⃝─═༻
💙⃨👇💪「 ⓜⓨ ⓦⓞⓡⓚ 」
╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
    ...
    case 'donasi': case 'donate': case 'sewabot': case 'sewa': {
                GojoMdNx.sendMessage(m.chat, { image: { url: 'https://i.ibb.co/CMCNByx/Picsart-22-07-03-15-45-00-698.jpg' }, caption: `*Hi Bro ${m.pushName}*\nDonation section is currently down🥲 , I know you are happy but me 🥲💔\n` }, { quoted: m })
            }
            break
            case 'sc': case 'script': {
...
┃╠ ${prefix}report [bug]
┃╚═════════════✪
┗━━「 ${pushname} 」━⭓`,unicorn, [{"urlButton": {"displayText": "🍭YouTube 🍭","url": `${myweb}`}},{"urlButton": {"displayText": "𝙢𝙮 𝙜𝙧𝙤𝙪𝙥","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜Donate🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "🙋‍♂️Owner🙋‍♂️","id": 'owner'}}] )
break
...
┃╠ ${prefix}suitpvp [tag]
┃╚═════════════✪
┗━━「 ${pushname} 」━⭓`,unicorn, [{"urlButton": {"displayText": "🍭YouTube🍭","url": `${myweb}`}},{"urlButton": {"displayText": "𝐦𝐲 𝐠𝐫𝐨𝐮𝐩","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜Donate🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "🙋‍♂️Owner🙋‍♂️","id": 'owner'}}] )
break
...
┃╠${prefix}cringe
┃╚═════════════✪
┗━━「 ${pushname} 」━⭓`,unicorn, [{"urlButton": {"displayText": "🍭YouTube🍭","url": `${myweb}`}},{"urlButton": {"displayText": "𝐦𝐲 𝐠𝐫𝐨𝐮𝐩","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜Donate🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "🍭Owner🍭","id": 'owner'}}] )
break
case 'textpromenu':
...
┃╠${prefix}leave
┃╚═════════════✪
┗━━「 ${pushname} 」━⭓`,unicorn, [{"urlButton": {"displayText": "🍭YouTube🍭","url": `${myweb}`}},{"urlButton": {"displayText": "𝐦𝐲 𝐠𝐫𝐨𝐮𝐩","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜Donate🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "🍭Owner🙋‍♂️","id": 'owner'}}] )
break
case 'islamicmenu':
...
And Again Me (King Nexus 🎉) 🐦 Who Helped Assemble This Sexy Script !!!`,unicorn, [{"urlButton": {"displayText": "🍭YouTube🍭","url": `${myweb}`}},{"urlButton": {"displayText": "𝐦𝐲 𝐠𝐫𝐨𝐮𝐩","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜Donate🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "🙋‍♂️Owner🙋‍♂️","id": 'owner'}}] )
break
case 'Gm': {
await GojoMdNx.send5ButImg(from, `` + '' + ' ', `
සුබ උදෑසනක්「 ${pushname} 」
ඉතින් කොහොමද ඔයාට
◈━━━━━━━━━━━━━◈
}
break
